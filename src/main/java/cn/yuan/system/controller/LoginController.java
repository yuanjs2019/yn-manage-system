package cn.yuan.system.controller;
...
import cn.yuan.common.util.MD5Utils;
import cn.yuan.common.util.vcode.Captcha;
import cn.yuan.common.util.vcode.GifCaptcha;
import cn.yuan.system.domain.User;
import cn.yuan.system.service.UserService;
    ...
    public void getGifCode(HttpServletResponse response, HttpServletRequest request) {
        try {
            ...
            Captcha captcha = new GifCaptcha(
                    ynProperties.getValidateCode().getWidth(),
                    ynProperties.getValidateCode().getHeight(),
                    ynProperties.getValidateCode().getLength());
